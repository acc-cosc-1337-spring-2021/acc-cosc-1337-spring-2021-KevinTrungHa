...
{	
	...
	// get input from user, capture a number from keyboard
	int grade_from_user;
	...
	{
		//call functions get_letter_grade_using_if and get_letter_grade_using_switch 
		//to display the letter grade to screen
